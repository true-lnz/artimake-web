...
export default function AppCta() {
  ...
  return (
    <section className="relative mx-auto flex min-h-[400px] w-full max-w-screen-xl items-center overflow-visible rounded-[34px] bg-[#1D2028] px-5 py-5 text-[#F6F4EE] shadow-[0_18px_42px_-6px_rgba(18,20,26,0.24)] sm:min-h-[440px] sm:px-8 sm:py-6 lg:min-h-[400px] lg:px-12 lg:py-6">
      <div
        aria-hidden="true"
      ...
      <div className="relative z-10 mx-auto grid w-full max-w-screen-xl items-center gap-10 lg:grid-cols-[1.15fr_0.85fr] lg:gap-12">
        <div className="order-2 flex flex-col lg:order-1">
          ...
          >
            <h2 className="max-w-[18ch] text-[32px] font-semibold leading-[1.12] tracking-wide sm:max-w-[17ch] sm:text-[44px] sm:leading-[1.08]">
              Управляйте креслом в&nbsp;приложении
            </h2>
            <p className="mt-5 max-w-lg text-base leading-7 text-[#DADDE6]">
          ...
          >
            <Link
              ...
              className={cn(
                ...
                "h-14 rounded-full bg-[#34848C] px-6 text-base text-[#F6F4EE] shadow-[0_12px_14px_rgba(18,20,26,0.18)] hover:bg-[#43959d]",
              )}
            >
              О приложении
            ...
            <DownloadAppButton
              variant="ghost"
              size="lg"
              className="h-14 rounded-full border border-white/15 px-6 text-[#F6F4EE] hover:bg-white/10 hover:text-white"
            />
          </motion.div>
        </div>

        <div className="relative order-1 grid min-h-[300px] place-items-center lg:absolute lg:inset-y-0 lg:right-0 lg:order-2 lg:w-[48%]">
          <div
            aria-hidden="true"
            className="absolute h-72 w-72 rounded-full border border-[#34848C]/35 sm:h-80 sm:w-80"
          />
          <motion.div
            className="relative z-10 h-[clamp(420px,52vw,540px)] w-[clamp(324px,40vw,416px)]"
          ...
          >
            <Image
              ...
              fill
              sizes="360px"
              className="object-contain drop-shadow-[0_24px_30px_rgba(0,0,0,0.32)]"
              priority
            />
          </motion.div>
